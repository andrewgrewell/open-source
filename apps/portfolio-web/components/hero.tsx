...
export function Hero() {
  return (
    <Section>
      <div className="flex flex-1 items-center justify-center max-md:justify-start max-md:flex-col py-12">
        <div className="flex mr-8 max-md:mr-0 max-md:mb-2">
          <AgLogo className="w-32 max-md:w-24 h-auto" />
        </div>
        <div>
          <h1 className="text-left mx-auto max-w-4xl font-heading text-5xl font-black tracking-tight text-slate-600 max-md:text-2xl max-md:text-center">
