...
export const verifyEmail = {
  executor: async (options: VerifyEmailOptions, dataModels: TableModelsMap) => {
    const { Account, AccountVerifyCode } = dataModels;
    const { accountId, code, email } = options;
